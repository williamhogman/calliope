...
pub const BANDS: &[Band] = &[
    ...
    Band { name: "pack bytes per cell", sweet: (0.0, 23.0), hard: (0.0, 26.0), target: "sweet ≤23 · hard ≤26 (5×u16 + 4×u8-quantized + 6×u8 raw = 20 B/cell + header — M54's aquifer rides the 8-bit lane)" },
