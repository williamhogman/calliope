...
pub fn all_bands() -> impl Iterator<Item = &'static Band> {
    crate::geo::BANDS
        ...
        .chain(crate::ages::BANDS)
        .chain(crate::biomes::BANDS)
        .chain(crate::agriculture::BANDS)
        .chain(crate::drought::BANDS)
        .chain(crate::famine::BANDS)
        .chain(crate::migration::BANDS)
        .chain(crate::flood::BANDS)
        .chain(crate::hydrology::BANDS)
        .chain(crate::hydrology::LAKE_BANDS)
        .chain(crate::dryedge::BANDS)
        .chain(crate::steppe::BANDS)
