 ...
 * @property {number} dp
 * @property {{capacity_cell: number, cells: number, contested: number, farmed: number, frontier: number, full: number, herds: number, line: number, pressed: boolean, pressure: number, push_mm: number, range: number, sky: number, spoken: null, text: string, unrest: number, want_p: number, want_t: number}} [herds]
