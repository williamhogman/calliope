...
- [ ] E5.6 `artifact::monthly` takes `&new_events[month_start..]`, not a full clone (`world.rs:1794`) (S)
- [ ] E5.7 Merchant pass stops cloning every good name per area per month (`economy.rs:751-752`) (S)
